...
?>	
	...
	<div id="pagelist" class="hide"><h2><?php _e('Download Your Facebook Page Reviews', 'wp-fb-reviews'); ?></h2><p><?php _e('Click the button below for the page(s) you would like to display reviews for. Afterwords go to the "Reviews List" Page to see all your reviews.', 'wp-fb-reviews'); ?> </p>
